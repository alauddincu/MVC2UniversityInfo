...
namespace MVC2.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="CourseId,Code,Credit,Description,SemesterId,DepartmentId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CourseId,Code,Credit,Description,SemesterId,DepartmentId")] Course course)
        {
            if (ModelState.IsValid)
            {
