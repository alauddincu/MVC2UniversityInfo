...
namespace MVC2.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="TeacherId,Name,Address,Email,ContactNo,Credit,DesignationId,DepartmentId")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="TeacherId,Name,Address,Email,ContactNo,Credit,DesignationId,DepartmentId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
